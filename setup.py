...
with open("Xphate/__init__.py", "rb") as f:
    hit = _version_re.search(f.read().decode("utf-8")).group(1)
    version = str(ast.literal_eval(hit))

standalone = ['Xphate=Xphate.scripts._standalone_xphate:standalone_xphate']
...
setup(
    ...
    url="https://github.com/FranckLejzerowicz/Xphate",
